  ...
  fn fmt(
    ...
    match self {
      ...
      DiagnosticMessage::InvalidThis(this) => {
        write!(f, "Invalid 'this' outside of namespace '{}'", this.lexeme)
      },
...
impl DiagnosticMessage {
  fn code(&self) -> String {
    match self {
      ...
      DiagnosticMessage::ExpectedExpression(_) => "I0004".to_string(),
      DiagnosticMessage::ExpectedVariableName(_) => "I0005".to_string(),
      DiagnosticMessage::ExpectedReturnTypeAfterFunction(_) => "I0006".to_string(),
      DiagnosticMessage::ExpectedAfterExpression(_, _, _) => "I0007".to_string(),
      DiagnosticMessage::ExpectedExpressionAfter(_) => "I0008".to_string(),
      DiagnosticMessage::InvalidAssignmentTarget(_) => "I0009".to_string(),
      DiagnosticMessage::ExpectedTypeAfterVariable(_) => "I0010".to_string(),
      DiagnosticMessage::InvalidNumberOfArguments(_, _, _) => "I0011".to_string(),
      DiagnosticMessage::ExpectedSemicolonAfterExpression(_) => "I0012".to_string(),
      DiagnosticMessage::InvalidEnumMember(_) => "I0013".to_string(),
      DiagnosticMessage::ExpectedTypeAfterPipe(_) => "I0014".to_string(),
      DiagnosticMessage::ExpectedDelimiter(_) => "I0015".to_string(),
      DiagnosticMessage::ExpectedType(_) => "I0016".to_string(),
      DiagnosticMessage::UnexpectedKeyword(_) => "I0017".to_string(),
      DiagnosticMessage::ExpectedIdentifier(_) => "I0018".to_string(),
      DiagnosticMessage::UninitializedConstant(_) => "I0019".to_string(),
      DiagnosticMessage::ExpectedPattern(_) => "I0020".to_string(),
      DiagnosticMessage::UntermintedComment(_) => "I0021".to_string(),
      DiagnosticMessage::UntermintedCharacter(_) => "I0022".to_string(),
      DiagnosticMessage::InvalidCharacterEscapeSequence(_) => "I0023".to_string(),
      DiagnosticMessage::InvalidCharacter(_) => "I0024".to_string(),
      DiagnosticMessage::UnterminatedString(_) => "I0025".to_string(),
      DiagnosticMessage::UnexpectedGenerics(_) => "I0026".to_string(),
      DiagnosticMessage::UndefinedMeta(_) => "I0027".to_string(),
      DiagnosticMessage::InvalidMetaEntity(_, _) => "I0028".to_string(),
      DiagnosticMessage::MissingArgument(_) => "I0029".to_string(),
      DiagnosticMessage::InvalidArgumentType(_, _) => "I0030".to_string(),
      DiagnosticMessage::TypeMismatch(_, _, _) => "I0031".to_string(),
      DiagnosticMessage::InvalidProperty(_) => "I0032".to_string(),
      DiagnosticMessage::UndeclaredVariable(_) => "I0033".to_string(),
      DiagnosticMessage::InvalidUnaryOperatorForDataType(_, _) => "I0034".to_string(),
      DiagnosticMessage::NotCallable(_) => "I0035".to_string(),
      DiagnosticMessage::AssingInvalidType(_, _, _) => "I0036".to_string(),
      DiagnosticMessage::InvalidComparison(_, _, _) => "I0037".to_string(),
      DiagnosticMessage::InvalidOperator(_) => "I0038".to_string(),
      DiagnosticMessage::InvalidUnaryOperator(_) => "I0039".to_string(),
      DiagnosticMessage::UndefinedVariable(_) => "I0040".to_string(),
      DiagnosticMessage::VariableAlreadyDefined(_, _) => "I0041".to_string(),
      DiagnosticMessage::InvalidReassignedVariable(_) => "I0042".to_string(),
      DiagnosticMessage::TypeMismatchUnary(_, _) => "I0043".to_string(),
      DiagnosticMessage::CannotSubtract(_, _, _) => "I0044".to_string(),
      DiagnosticMessage::CannotMultiply(_, _, _) => "I0045".to_string(),
      DiagnosticMessage::CannotDivide(_, _, _) => "I0046".to_string(),
      DiagnosticMessage::CannotModulo(_, _, _) => "I0047".to_string(),
      DiagnosticMessage::FunctionAlreadyDefined(_, _) => "I0048".to_string(),
      ...
      DiagnosticMessage::PropertyAlreadyDefined(_) => "I0059".to_string(),
      DiagnosticMessage::MethodAlreadyDefined(_) => "I0060".to_string(),
      DiagnosticMessage::UndefinedProperty(_) => "I0061".to_string(),
      DiagnosticMessage::UndefinedMethods(_) => "I0062".to_string(),
      DiagnosticMessage::ImmutableProperty(_) => "I0063".to_string(),
      DiagnosticMessage::PrivateProperty(_) => "I0064".to_string(),
      DiagnosticMessage::FunctionNotDefined(_, _) => "I0065".to_string(),
      DiagnosticMessage::VariableNeverUsed(_) => "I0066".to_string(),
      DiagnosticMessage::NotAnVector(_) => "I0067".to_string(),
      DiagnosticMessage::InvalidVectorIndex(_) => "I0068".to_string(),
      DiagnosticMessage::InvalidVariableInitializer(_) => "I0069".to_string(),
      DiagnosticMessage::EnumAlreadyDefined(_) => "I0070".to_string(),
      DiagnosticMessage::EnumMemberTypeMismatch(_, _, _) => "I0071".to_string(),
      DiagnosticMessage::NotAnEnum(_) => "I0072".to_string(),
      DiagnosticMessage::UndefinedEnum(_) => "I0073".to_string(),
      DiagnosticMessage::UndefinedEnumMember(_) => "I0074".to_string(),
      DiagnosticMessage::EnumAssignmentError(_, _) => "I0075".to_string(),
      DiagnosticMessage::UndefinedImport(_) => "I0076".to_string(),
      DiagnosticMessage::IncorrectNumberOfGenericArguments(_, _, _) => "I0077".to_string(),
      DiagnosticMessage::MethodImplementationParameterMismatch(_, _, _) => "I0078".to_string(),
      DiagnosticMessage::MethodImplementationError(_, _) => "I0079".to_string(),
      DiagnosticMessage::MethodImplementationReturnTypeMismatch(_, _, _) => "I0080".to_string(),
      DiagnosticMessage::TypeAlreadyDefined(_) => "I0081".to_string(),
      DiagnosticMessage::InvalidTypeValue(_) => "I0082".to_string(),
      DiagnosticMessage::UndefinedType(_, _) => "I0083".to_string(),
      DiagnosticMessage::TupleTypeMismatch(_, _, _) => "I0084".to_string(),
      DiagnosticMessage::ReturnTypeMismatch(_, _, _) => "I0085".to_string(),
      DiagnosticMessage::ImportedEnumIsNotExported(_) => "I0086".to_string(),
      DiagnosticMessage::ImportedTypeIsNotExported(_) => "I0087".to_string(),
      DiagnosticMessage::ImportedTypeNotFound(_, _) => "I0088".to_string(),
      DiagnosticMessage::InvalidCast(_, _, _) => "I0089".to_string(),
      DiagnosticMessage::RecordAlreadyDefined(_) => "I0090".to_string(),
      DiagnosticMessage::UndefinedRecord(_) => "I0091".to_string(),
      DiagnosticMessage::ConstantAlreadyDefined(_) => "I0092".to_string(),
      DiagnosticMessage::ReassignedConstant(_) => "I0093".to_string(),
      DiagnosticMessage::DecoratorAlreadyDefined(_) => "I0094".to_string(),
      DiagnosticMessage::UndefinedDecorator(_) => "I0095".to_string(),
      DiagnosticMessage::ImportedRecordIsNotExported(_) => "I0096".to_string(),
      DiagnosticMessage::ImportedDecoratorIsNotExported(_) => "I0097".to_string(),
      DiagnosticMessage::InvalidExternStatement(_) => "I0098".to_string(),
      DiagnosticMessage::ImportedExternIsNotExported(_) => "I0099".to_string(),
      DiagnosticMessage::ValueOutOfRange(_, _, _) => "I0100".to_string(),
      DiagnosticMessage::InvalidThis(_) => "I0101".to_string(),
      DiagnosticMessage::MutationOnImmutableError(_, _) => "I0102".to_string(),
      DiagnosticMessage::ExpectedReference(_, _, _) => "I0103".to_string(),
      DiagnosticMessage::UnexpectedReference(_, _) => "I0104".to_string(),
      DiagnosticMessage::BorrowedValueHasMoved(_) => "I0105".to_string(),
      DiagnosticMessage::PotentialTypeMismatch(_, _, _) => "I0106".to_string(),
      DiagnosticMessage::InvalidTypeArgument(_, _, _) => "I0107".to_string(),
      DiagnosticMessage::InvalidPropertyType(_) => "I0108".to_string(),
      DiagnosticMessage::InvalidSpreadExpression(_) => "I0109".to_string(),
      DiagnosticMessage::InvalidParameterAfterVariadic(_) => "I0110".to_string(),
      DiagnosticMessage::InvalidParameterAfterOptional(_) => "I0111".to_string(),
      DiagnosticMessage::ImportedNamespaceIsNotExported(_) => "I0112".to_string(),
      DiagnosticMessage::ExternAlreadyDefined(_) => "I0113".to_string(),
